...
function getAttendanceSummary($conn, $section_filter, $date_from, $date_to, $status_filter) {
    $query = "SELECT 
                s.section,
                c.course_name,
...
if (!empty($section_filter) || (!empty($date_from) && !empty($date_to)) || !empty($status_filter)) {
    $summary_data = getAttendanceSummary($conn, $section_filter, $date_from, $date_to, $status_filter);
}
?>
    ...
    <div class="min-h-screen">
        ...
        <div class="p-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex justify-between items-center">
                ...
                <a href="display_attendance.php" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
            ...
            <?php if (!empty($summary_data)): ?>
                ...
                <div class="flex justify-end mb-6">
                    <form action="export_summary.php" method="POST">
